...
<table class="voucher" style=" width: 145px; height:90px; padding-right:5px " >
  <tbody >
<!-- Logo Hotspotname -->
		  <tr>
...
<!-- /  -->
    <tr>
      <td>
    <table style=" text-align: center; width: 145px; height:115px padding-right:5px; font-size: 12px;">
  <tbody>
...
<?php if ($usermode == "vc") { ?>
        <tr>
          <td style="font-size:8px; color: black">Voucher Code</td>
        </tr>
        <tr>
...
<!-- /  -->
    <tr>
      <!-- Price  -->
      <td colspan="2" style=" margin-right:8px;color: black; font-weight:bold; margin-bottom:4px; font-size:12px"><?= $validity; ?> <?= $timelimit; ?> <?= $datalimit; ?> <!-- <?= $price; ?> --> </td>
<!-- /  -->
    </tr>
	  <!--
    <tr>
